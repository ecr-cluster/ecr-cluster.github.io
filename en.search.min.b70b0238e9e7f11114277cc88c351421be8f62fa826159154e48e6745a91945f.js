...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.80d879aeeaf416f759d418f608a2dca2858af256c819d3cead7d9331497c61e4.js',function(){input.required=false;search();});}
