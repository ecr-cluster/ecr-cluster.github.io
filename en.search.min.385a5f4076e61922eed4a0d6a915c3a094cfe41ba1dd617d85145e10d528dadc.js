...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fbc997445402be42e5f80a7c018e18c56a7aa50c6e6bf288acfe61db27dd6278.js',function(){input.required=false;search();});}
